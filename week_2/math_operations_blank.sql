...
--   Show me the days that had gaps greater than 85 between open & close.
...
SELECT *,
	   ...
	   volume_btc^(1/3.0) AS cbrt_vol_btc
FROM coinbase;
...
SELECT *,
	  ...
	  --CEIL() or FLOOR() to force rounding direction
FROM coinbase
