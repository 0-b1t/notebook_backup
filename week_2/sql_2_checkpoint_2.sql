...
SELECT garagetype, AVG(garagearea/NULLIF(garagecars,0)) AS avg_area_per_garage_bay --dividing by zero without NULLIF
FROM houseprices																	--forces sql to ignore undesired records
GROUP BY garagetype;
